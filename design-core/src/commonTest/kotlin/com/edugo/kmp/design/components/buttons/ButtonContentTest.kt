...
class ButtonContentTest {
    ...
    @Test
    fun rendersTextOnly() = runComposeUiTest {
        setContent {
            DSTheme {
    ...
    @Test
    fun rendersLeadingIcon() = runComposeUiTest {
        setContent {
            DSTheme {
                Row(Modifier.testTag(rootTag)) {
    ...
    @Test
    fun rendersTrailingIcon() = runComposeUiTest {
        setContent {
            DSTheme {
                Row(Modifier.testTag(rootTag)) {
    ...
    @Test
    fun rendersBothIcons() = runComposeUiTest {
        setContent {
            DSTheme {
                Row(Modifier.testTag(rootTag)) {
                    ButtonContent(
    ...
    @Test
    fun rendersProgressWhenLoading() = runComposeUiTest {
        setContent {
            DSTheme {
                Row(Modifier.testTag(rootTag)) {
    ...
    @Test
    fun loadingHidesLeadingIcon() = runComposeUiTest {
