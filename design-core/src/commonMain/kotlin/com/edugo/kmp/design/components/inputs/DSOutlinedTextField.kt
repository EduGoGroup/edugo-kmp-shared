...
@Preview(name = "DSOutlinedTextField - Light", showBackground = true)
@Composable
fun DSOutlinedTextFieldPreviewLight() {
...
@Preview(name = "DSOutlinedTextField - Dark", showBackground = true)
@Composable
private fun DSOutlinedTextFieldPreviewDark() {
    var value by remember { mutableStateOf("Ejemplo") }
